...
An email address was planted in the corpus before this run (`--break`) and removed afterwards.
...
VERIFICATION FAILED. Nothing may be marked `passing` until this exits 0.
```
